...
<div class="max-w-2xl mx-auto">
    <div class="mb-6">
        <h2 class="text-2xl font-bold text-gray-800">Tambah Nasabah Baru</h2>
        <p class="text-gray-500 text-sm mt-1">Isi formulir di bawah ini untuk menambahkan nasabah baru.</p>
    </div>
    ...
    <form action="{{ route('customers.store') }}" method="POST" class="space-y-6">
        ...
        <div>
            ...
            <div class="relative rounded-md shadow-sm">
                ...
                <input type="text" name="name" id="name" class="focus:ring-primary-500 focus:border-primary-500 block w-full pl-10 sm:text-sm border-gray-300 rounded-lg py-3" placeholder="Masukkan nama lengkap nasabah" required>
            </div>
            @error('name')
